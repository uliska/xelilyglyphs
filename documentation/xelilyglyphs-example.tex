...
%                                ==========                              %
%                                                                        %
%              https://github.com/uliska/xelilyglyphs                    %
%                                                                        %
...
With the new package \xelilyglyphs{} you can easily insert the notational elements of the LilyPond%
...
One thing that sets \xelilyglyphs{} apart from other solutions I had investigated is that one isn't restricted to a set of predefined symbols but is able to print \emph{any notation} that can be realized with LilyPond.
...
\medskip
Sounds too good to be true? Well, there’s one catch to it: \xelilyglyphs{} is a \LaTeX{}%
...
For more information you may contact us through \href{mailto:git@ursliska.de}{git@ursliska.de}.
